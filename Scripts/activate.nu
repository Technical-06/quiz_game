...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Admin\OneDrive - Chandigarh University\Desktop\pythonPrograms\venv'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Admin\OneDrive - Chandigarh University\Desktop\pythonPrograms\venv\Scripts\deactivate.nu'
